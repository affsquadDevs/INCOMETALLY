...
export const metadata: Metadata = {
  ...
  description: 'Free salary tax calculators for multiple countries. Calculate your net income after taxes and social contributions in the US, Germany, UK, and more.',
  alternates: {
    canonical: `${siteConfig.domain}/salary-calculator`, // Canonical hub URL
  },
  openGraph: {
    title: 'Salary Tax Calculator Hub - Calculate Net Income by Country',
    description: 'Free salary tax calculators for multiple countries. Calculate your net income after taxes and social contributions.',
    type: 'website',
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 py-16">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-black opacity-70 mb-6">
            Calculate your net income after taxes and social contributions. Our free calculators help you understand how much you&apos;ll take home in different countries, with detailed breakdowns of income tax, social security contributions, and other deductions.
          </p>
          <p className="text-base text-black opacity-70">
            Select a country below to get started, or choose a calculation mode that fits your needs.
          </p>
        </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-sm text-black opacity-70 mb-4">
                  Convert your hourly wage to annual, monthly, and weekly salary. Perfect for understanding your total compensation when negotiating or comparing job offers.
                </p>
                <span className="text-sm text-black opacity-70 underline">
                  Convert Hourly Rate →
                </span>
              ...
              >
                ...
                <p className="text-sm text-black opacity-70 mb-4">
                  Calculate net income when you know your hourly rate. Includes options for custom hours per week and weeks per year to match your work schedule.
                </p>
                <span className="text-sm text-black opacity-70 underline">
                  Calculate Hourly →
                </span>
              ...
              >
                ...
                <p className="text-sm text-black opacity-70 mb-4">
                  Calculate your net monthly income after taxes. Ideal for budgeting and understanding your monthly take-home pay.
                </p>
                <span className="text-sm text-black opacity-70 underline">
                  Calculate Monthly →
                </span>
              ...
              >
                ...
                <p className="text-sm text-black opacity-70 mb-4">
                  Calculate your net annual income from your gross yearly salary. See the full breakdown of taxes and deductions for the entire year.
                </p>
                <span className="text-sm text-black opacity-70 underline">
                  Calculate Yearly →
                </span>
